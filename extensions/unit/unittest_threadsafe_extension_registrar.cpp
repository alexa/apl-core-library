...
* Test class;
*/
class ThreadSafeExtensionRegistrarTest : public ::testing::Test {
public:
   ThreadSafeExtensionRegistrarPtr extRegistrar;
};
...
TEST_F(ThreadSafeExtensionRegistrarTest, BasicLocallyRegisteredProxy) {
   auto test1 = std::make_shared<TextExtensionProxy>("test1");
   auto test2 = std::make_shared<TextExtensionProxy>("test2");

   extRegistrar = std::make_shared<ThreadSafeExtensionRegistrar>(std::set<ExtensionProviderPtr>(), std::set<ExtensionProxyPtr>{test1, test2});
...
TEST_F(ThreadSafeExtensionRegistrarTest, MultipleProviders) {
   auto test1 = std::make_shared<TextExtensionProxy>("test1");
   auto test2 = std::make_shared<TextExtensionProxy>("test2");
   ...
   extRegistrar = std::make_shared<ThreadSafeExtensionRegistrar>(std::set<ExtensionProviderPtr>{tp1, tp2},
                                                                 std::set<ExtensionProxyPtr>{test1, test2});
...
TEST_F(ThreadSafeExtensionRegistrarTest, ReturnsSame) {
   auto test1 = std::make_shared<TextExtensionProxy>("test1");
   auto tp1 = std::make_shared<TestProvider>("provider1");

   extRegistrar = std::make_shared<ThreadSafeExtensionRegistrar>(std::set<ExtensionProviderPtr>{tp1},
                                                                 std::set<ExtensionProxyPtr>{test1});
