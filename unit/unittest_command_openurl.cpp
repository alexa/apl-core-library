...
TEST_F(CommandOpenURLTest, OpenURLFail) 
{
    ...
    ASSERT_EQ(Object("failed"), event.getValue(kEventPropertyArguments).at(0));
    ASSERT_EQ(Object("OpenURL"), event.getValue(kEventPropertyArguments).at(1));
    ASSERT_EQ(Object("Fail"), event.getValue(kEventPropertyArguments).at(2));
    ASSERT_EQ(Object(23), event.getValue(kEventPropertyArguments).at(3));
}
...
TEST_F(CommandOpenURLTest, OpenURLNotAllowed)
{
    ...
    ASSERT_EQ(Object("OpenURL"), event.getValue(kEventPropertyArguments).at(1));
    ASSERT_EQ(Object("Fail"), event.getValue(kEventPropertyArguments).at(2));
    ASSERT_EQ(Object(405), event.getValue(kEventPropertyArguments).at(3));
}
...
TEST_F(CommandOpenURLTest, OpenURLDelay)
{
    ...
    event = root->popEvent();
    ASSERT_EQ(kEventTypeSendEvent, event.getType());
    ASSERT_EQ(Object("succeeded"), event.getValue(kEventPropertyArguments).at(0));
}
...
TEST_F(CommandOpenURLTest, OpenURLDelayFail)
{
    ...
    ASSERT_EQ(Object("OpenURL"), event.getValue(kEventPropertyArguments).at(1));
    ASSERT_EQ(Object("Fail"), event.getValue(kEventPropertyArguments).at(2));
    ASSERT_EQ(Object(123), event.getValue(kEventPropertyArguments).at(3));
}
...
TEST_F(CommandOpenURLTest, OpenURLCancel)
{
    ...
    goButton->update(kUpdatePressed, 1);

    ASSERT_FALSE(root->hasEvent());
    loop->advanceToTime(500);

    cancelButton->update(kUpdatePressed, 1);
    loop->advanceToEnd();
    ASSERT_FALSE(root->hasEvent());
}
