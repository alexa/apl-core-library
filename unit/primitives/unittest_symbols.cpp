...
std::map<std::string, std::vector<std::pair<std::string, std::string>>> BASIC_TESTS = {
    ...
    {"${c}",                                                  {{"CONTEXT_1", "c/"}}},
    {"${c[0]}",                                               {{"CONTEXT_1", "c/0/"}}},
    {"${c[a]}",                                               {{"CONTEXT_1", "c/23/"},        {"CONTEXT_1", "a/"}}},
    {"${c[b]}",                                               {{"CONTEXT_1", "c/2/"},         {"CONTEXT_2", "b/"}}},
    {"${c[23 + c[b]]}",                                       {{"CONTEXT_2", "b/"},           {"CONTEXT_1", "c/26/"},       {"CONTEXT_1", "c/2/"}}},
    {"${b} ${Math.min(24,c[a+1])}",                           {{"CONTEXT_1", "c/24/"},        {"CONTEXT_1", "a/"},          {"CONTEXT_2", "b/"}}},
    {"${c[-1]}",                                              {{"CONTEXT_1", "c/-1/"}}},
    {"${d}",                                                  {{"CONTEXT_2", "d/"}}},
    ...
    {"${d.friends[c[2]]}",                                    {{"CONTEXT_1", "c/2/"},         {"CONTEXT_2", "d/friends/3/"}}},
    {"${c[d.friends.length - 2]}",                            {{"CONTEXT_1", "c/1/"},         {"CONTEXT_2", "d/friends/length/"}}},
    ...
    {"${String.toUpperCase(d.friends[d.friends.length-1])}",  {{"CONTEXT_2", "d/friends/2/"}, {"CONTEXT_2", "d/friends/length/"}}},
