...
TEST_F(GesturesTest, DoublePressChangesTargetBetweenClicks) {
    ...
    root->updateTime(800); // trigger timeout
...
TEST_F(GesturesTest, SwipeAwayFlickLeftSlide)
{
    ...
    ASSERT_TRUE(CheckEvent("onSwipeMove", 0.65, "left"));
