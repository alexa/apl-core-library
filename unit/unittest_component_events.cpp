...
TEST_F(ComponentEventsTest, TouchWrapperSendEvent)
{
    ...
    ASSERT_EQ(apl::Object::kMapType, source.getType());
                   ...
                   const Object& value)
{
    ...
    ASSERT_EQ(value, arguments.at(1));
    ASSERT_EQ("1", arguments.at(2).asString());
    ASSERT_EQ("", arguments.at(3).asString());
    ASSERT_EQ(trackIndex, arguments.at(4).asString()); // trackIndex
    ...
    auto components = event.getValue(kEventPropertyComponents);
    ASSERT_EQ(apl::Object::kMapType, components.getType());
    ASSERT_EQ("One", components.get("textComp").asString());
}
...
TEST_F(ComponentEventsTest, MediaOnTimeUpdate)
{
    ...
    ASSERT_TRUE(arguments.at(3).isNull()); // Source
