...
/**
  * Test intrinsic keys are recognized.
  */
TEST(Keyboard, Intrinsic) {

    ASSERT_TRUE(Keyboard::BACK_KEY().isReservedKey());
    ASSERT_TRUE(Keyboard::ENTER_KEY().isReservedKey());
    ASSERT_TRUE(Keyboard::ARROW_UP_KEY().isReservedKey());
    ASSERT_TRUE(Keyboard::ARROW_DOWN_KEY().isReservedKey());
    ASSERT_TRUE(Keyboard::ARROW_LEFT_KEY().isReservedKey());
    ASSERT_TRUE(Keyboard::ARROW_RIGHT_KEY().isReservedKey());
    ...
    ASSERT_TRUE(Keyboard("Enter", "Enter").isReservedKey());
