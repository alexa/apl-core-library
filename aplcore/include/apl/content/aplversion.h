...
public:
    enum Value : uint32_t {
        ...
        kAPLVersionLatest = kAPLVersion20231to20232, /// Support the most recent engine version
        kAPLVersionDefault = kAPLVersion20231to20232, /// Default value
        kAPLVersionReported = kAPLVersion20232, /// Default reported version
