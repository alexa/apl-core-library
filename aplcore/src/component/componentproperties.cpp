...
Bimap<int, std::string> sComponentPropertyBimap = {
    {kPropertyAccessibilityActions,         "_actions"},
    {kPropertyAccessibilityActionsAssigned, "action"},
    {kPropertyAccessibilityActionsAssigned, "actions"},
    {kPropertyAccessibilityAdjustableRange, "accessibilityAdjustableRange"},
    {kPropertyAccessibilityAdjustableValue, "accessibilityAdjustableValue"},
    ...
    {kPropertyBackgroundAssigned,           "background"},
    {kPropertyBackground,                   "_background"},
    ...
    {kPropertyEmbeddedDocument,             "embeddedDocument"},
    {kPropertyEnd,                          "end"},
    {kPropertyEntities,                     "entities"},
    {kPropertyEntities,                     "entity"},
    {kPropertyEnvironment,                  "environment"},
    ...
    {kPropertyHandleVisibilityChange,       "handleVisibilityChange"},
    ...
    {kPropertyOnSpeechMark,                 "onSpeechMark"},
    ...
    {kPropertyParameters,                   "parameters"},
    ...
    {kPropertyScreenLock,                   "screenLock"},
