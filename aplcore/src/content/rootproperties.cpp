...
Bimap<int, std::string> sRootPropertyBimap = {
        ...
        { RootProperty::kDisallowDialog,                              "disallowDialog" },
        ...
        { RootProperty::kMaximumTapVelocity,                          "tap.maxVelocity"},
        { RootProperty::kTickHandlerUpdateLimit,                      "tickHandlerUpdateLimit" },
        { RootProperty::kFontScale,                                   "fontScale" },
        { RootProperty::kInitialDisplayState,                         "initialDisplayState"},
        { RootProperty::kLayoutDirection,                             "layoutDirection"},
        { RootProperty::kTextMeasurementCacheLimit,                   "textMeasurementCacheLimit"},
