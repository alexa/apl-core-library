...
static const std::vector<PathTextCase> PATH_TESTS = {
    ...
    {"M10,10 20,20", "ML", {10, 10, 20, 20}},
    {"M5,10 20,30", "ML", {5, 10, 20, 30}}, 
    {"M5,10 m20 30", "", {}},
    {"m1 2 3 4 5 6", "MLL", {1,2,4,6,9,12}},
    ...
    {"M 0 0 A 0 0 0 0 1 0 0", "ML", {0, 0, 0, 0}}, // Shouldn't no-op with a blank path.
    ...
    {"A10,10 0 0110,10", "MC", {0,0,5.522847, 0, 10, 4.477152, 10, 10}},  // Flags are stuck together but still valid.
    ...
    {"M20,30 10,20 5,1 m20,20 3,3 M18,1 H5", "MLLMLML", { 20, 30, 10, 20, 5, 1, 25, 21, 28, 24, 18, 1, 5, 1}},
    {"L10,10 M20,20 30,30", "MLML", {0,0,10,10,20,20,30,30}},
};
