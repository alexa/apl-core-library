...
TEST_F(SGNodeBoundsTest, TextNode)
{
    ...
    auto properties =
        sg::TextProperties::create(cache, {"Arial"}, 12, FontStyle::kFontStyleNormal, "en-US", 500);
...
TEST_F(SGNodeBoundsTest, EditNode)
{
    ...
    sg::TextPropertiesCache cache;
    auto properties =
        sg::TextProperties::create(cache, {"Arial"}, 12, FontStyle::kFontStyleNormal, "klingon", 500);
