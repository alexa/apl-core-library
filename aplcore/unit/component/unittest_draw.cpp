...
TEST_F(ComponentDrawTest, Transforms) {
    ...
    child = as<CoreComponent>(root->findComponentById("1"));
    ...
    child = as<CoreComponent>(root->findComponentById("2"));
    ...
    child = as<CoreComponent>(root->findComponentById("3"));
    ...
    child = as<CoreComponent>(root->findComponentById("5"));
    ASSERT_TRUE(CheckAABB(Rect(100, 0, 100, 100), child));
