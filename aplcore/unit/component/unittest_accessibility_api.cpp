...
TEST_F(AccessibilityApiTest, Basic)
{
    ...
    auto notAccessibleFrame = root->findComponentById("notAccessibleFrame");
    ASSERT_FALSE(notAccessibleFrame->isFocusable());
    ASSERT_FALSE(notAccessibleFrame->isAccessible());

    auto transparentParent = root->findComponentById("transparentParent");
    ...
    auto slightlyTransparent = root->findComponentById("slightlyTransparent");
    ...
    auto sequence = root->findComponentById("sequence");
    ...
    auto nonAccessibleVG = root->findComponentById("nonAccessibleVG");
    ASSERT_FALSE(nonAccessibleVG->isFocusable());
    ASSERT_FALSE(nonAccessibleVG->isAccessible());

    auto accessibleVG = root->findComponentById("accessibleVG");
