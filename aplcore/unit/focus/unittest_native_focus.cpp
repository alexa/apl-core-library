...
TEST_F(NativeFocusTest, JumpBetweenTheRows)
{
    ...
    auto child = root->findComponentById("row1");
    ASSERT_EQ(child, fm.getFocus());
    ASSERT_TRUE(verifyFocusSwitchEvent(child, root->popEvent()));
    ...
    child = root->findComponentById("row2");
    ASSERT_EQ(child, fm.getFocus());
    ASSERT_TRUE(verifyFocusSwitchEvent(child, root->popEvent()));
    ...
    child = root->findComponentById("button2");
    ASSERT_EQ(child, fm.getFocus());
    ASSERT_TRUE(verifyFocusSwitchEvent(child, root->popEvent()));
    ...
    child = root->findComponentById("row3");
    ASSERT_EQ(child, fm.getFocus());
    ASSERT_TRUE(verifyFocusSwitchEvent(child, root->popEvent()));
    ...
    child = root->findComponentById("button3");
    ASSERT_EQ(child, fm.getFocus());
    ASSERT_TRUE(verifyFocusSwitchEvent(child, root->popEvent()));
    ...
    child = root->findComponentById("row4");
    ASSERT_EQ(child, fm.getFocus());
    ASSERT_TRUE(verifyFocusSwitchEvent(child, root->popEvent()));
}
...
TEST_F(NativeFocusTest, JustATest) {
    ...
    auto child = root->findComponentById("1000");
    ASSERT_EQ(child, fm.getFocus());
    ASSERT_TRUE(verifyFocusSwitchEvent(child, root->popEvent()));
}
