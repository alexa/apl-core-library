    ...
    "item": 
    {
      ...
      [
        ...
        },
        {
          ...
          "source": {
          "url": "URL1",
          "textTracks": [{ "url": "URL2", "type": "caption" }]
          }
        },
        {
          "type": "Video",
          "source": {
          "url": "URL1",
          "textTrack": [{ "url": "URL3", "type": "notcaption" }, { "url": "URL4", "type": "caption" }]
          }
        }
      ]
    }
...
TEST_F(BuilderTest, ResourceLookupAtBinding)
{
    ...
    ASSERT_TRUE(component);
    auto text = root->findComponentById("myText");
...
TEST_F(BuilderTest, BasicStartEndPaddingLTR)
{
    ...
    auto frame = root->findComponentById("paddedFrame");
    auto frame2 = root->findComponentById("paddedFrame2");
    auto child = root->findComponentById("paddedFrameChild");
    auto child2 = root->findComponentById("paddedFrameChild2");
...
TEST_F(BuilderTest, DynamicStartEndPaddingLTR)
{
    ...
    auto frame = CoreComponent::cast(root->findComponentById("paddedFrame"));
    auto frame2 = CoreComponent::cast(root->findComponentById("paddedFrame2"));
    auto child = CoreComponent::cast(root->findComponentById("paddedFrameChild"));
    auto child2 = CoreComponent::cast(root->findComponentById("paddedFrameChild2"));
...
TEST_F(BuilderTest, ComplexDynamicStartEndPaddingRTL)
{
    ...
    auto cont = CoreComponent::cast(root->findComponentById("cont"));
...
TEST_F(BuilderTest, PositionTypeRelativeToAbsolute)
{
    ...
    auto cont = CoreComponent::cast(root->findComponentById("frameComp1"));
...
TEST_F(BuilderTest, PositionTypeRelativeToAbsoluteStartEndInsets)
{
    ...
    auto cont = CoreComponent::cast(root->findComponentById("frameComp1"));
    auto containerComp = CoreComponent::cast(root->findComponentById("containerComp"));
