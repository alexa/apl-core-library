...
protected:
    ...
    DynamicSourceTest() {
        ds = std::make_shared<TestDataSourceProvider>(ITEMS);
        config->dataSourceProvider("GenericList", ds);
    }

    std::shared_ptr<TestDataSourceProvider> ds;
};
...
static const char *DATA_EMPTY = R"apl({
  "dynamicSource": {
    "type": "GenericList",
    "listId": "vQdpOESlok",
    "offset": 0,
...
static const char *DATA_BACKWARDS = R"apl({
  "dynamicSource": {
    "type": "GenericList",
    "listId": "vQdpOESlok",
    "offset": 15,
...
static const char *DATA_OFFSET = R"apl({
  "dynamicSource": {
    "type": "GenericList",
    "listId": "vQdpOESlok",
    "offset": 10,
...
static const char *EXPLICIT = R"apl({
  "type": "APL",
  "version": "1.3",
  "theme": "dark",
  "layouts": {
...
static const char *DATA_EXPLICIT = R"apl({
  "dynamicSource": {
    "type": "GenericList",
    "listId": "vQdpOESlok",
    "offset": 5,
...
static const char *DATA_EMPTY_OFFSET = R"apl({
  "dynamicSource": {
    "type": "GenericList",
    "listId": "vQdpOESlok",
    "offset": 5,
...
static const char *SIMPLE_SEQUENCE = R"apl({
  "type": "APL",
  "version": "1.3",
  "theme": "dark",
  "mainTemplate": {
...
static const char* NESTED_DATASOURCE_DOC = R"({
  "type": "APL",
  "version": "2023.2",
  "layouts": {
    "DynamicContainer": {
    ...
    "item": [
      {
        ...
        "listItems": "${magic.dynamicList}"
      }
    ]
  }
})";

static const char* NESTED_DATASOURCE_DATA = R"({
  "magic": {
    "dynamicList": {
      "listId": "vQdpOESlok",
      "type": "GenericList",
...
TEST_F(DynamicSourceTest, DynamicSourceNestedToLayout) {
    loadDocument(NESTED_DATASOURCE_DOC, NESTED_DATASOURCE_DATA);
    advanceTime(10);
    ...
    ASSERT_EQ(text1->getCalculated(kPropertyText).asString(), "Text 1");
    ASSERT_EQ(text2->getCalculated(kPropertyText).asString(), "Text 2");
}

static const char* INLINE_LAYOUT_DATASOURCE_DOC = R"({
  "type": "APL",
  "version": "2023.2",
  "layouts": {
    "DynamicContainer": {
...
static const char* INLINE_LAYOUT_DATASOURCE_DATA = R"({
  "magic": {
    "items": [
      { "text": "Text 1" },
      { "text": "Text 2" }
...
TEST_F(DynamicSourceTest, DynamicSourceInlineInLayout) {
    loadDocument(INLINE_LAYOUT_DATASOURCE_DOC, INLINE_LAYOUT_DATASOURCE_DATA);
    advanceTime(10);
...
static const char* PAYLOAD_SELECTION_DATASOURCE_DOC = R"({
  "type": "APL",
  "version": "2023.2",
  "layouts": {
    "DynamicContainer": {
      "parameters": [ "dynamicSource", "staticList" ],
      "item": [
        {
          "type": "Container",
          "data": "${!(staticList[0]) ? dynamicSource : staticList}",
          "height": "100%",
          "width": "100%",
          "items": [
            {
  ...
  "mainTemplate": {
    ...
    "item": [
      {
        "type": "DynamicContainer",
        "dynamicSource": "${payload['dynamicList']}",
        "staticList": "${payload.staticList}"
      }
    ]
  }
})";

static const char* PAYLOAD_SELECTION_HAVE_STATIC_DATASOURCE_DATA = R"({
  "dynamicList": {
    "listId": "vQdpOESlok",
    "type": "GenericList",
    "offset": 0,
...
TEST_F(DynamicSourceTest, DynamicSourcePayloadSelectionStatic) {
    loadDocument(PAYLOAD_SELECTION_DATASOURCE_DOC, PAYLOAD_SELECTION_HAVE_STATIC_DATASOURCE_DATA);
    advanceTime(10);
...
static const char* PAYLOAD_SELECTION_STATIC_EMPTY_DATASOURCE_DATA = R"({
  "dynamicList": {
    "listId": "vQdpOESlok",
    "type": "GenericList",
    "offset": 0,
...
TEST_F(DynamicSourceTest, DynamicSourcePayloadSelectionStaticEmpty) {
    ...
    ASSERT_EQ(text1->getCalculated(kPropertyText).asString(), "Text 3");
    ASSERT_EQ(text2->getCalculated(kPropertyText).asString(), "Text 4");
}
