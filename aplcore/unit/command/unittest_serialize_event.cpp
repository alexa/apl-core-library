...
class PokeCommand : public TemplatedCommand<PokeCommand> {
public:
    COMMAND_CONSTRUCTOR(PokeCommand);
...
TEST_F(SerializeEventTest, TargetContainer) {
    ...
    auto touchWrapper = root->findComponentById("MyButton");
...
TEST_F(SerializeEventTest, TargetScrollView) {
    ...
    auto scrollView = root->findComponentById("MyTarget");
...
TEST_F(SerializeEventTest, TargetSequence) {
    ...
    auto sequence = root->findComponentById("MyTarget");
...
TEST_F(SerializeEventTest, TargetTouchWrapper) {
    ...
    auto target = root->findComponentById("MyTarget");
    ASSERT_TRUE(target);
...
TEST_F(SerializeEventTest, BindReferences) {
    ...
    auto button = root->findComponentById("MyButton");
    ASSERT_TRUE(button);
...
TEST_F(SerializeEventTest, WeakReferences) {
    ...
    auto a = root->findComponentById("A");
    auto b = root->findComponentById("B");
    ASSERT_TRUE(a);
    ASSERT_TRUE(b);
