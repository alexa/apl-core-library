...
TEST_F(MountTest, PagerChildOnMount)
{
    ...
    auto affectedText = root->findComponentById("affectedText0");
    ASSERT_EQ("triggered", affectedText->getCalculated(kPropertyText).asString());

    affectedText = root->findComponentById("affectedText1");
    ...
    affectedText = root->findComponentById("affectedText2");
    ASSERT_FALSE(affectedText);
...
TEST_F(MountTest, SequenceChildOnMount)
{
    ...
    auto affectedText = root->findComponentById("text0");
    ...
    affectedText = root->findComponentById("text2");
    ASSERT_EQ("hit", affectedText->getCalculated(kPropertyText).asString());

    affectedText = root->findComponentById("text3");
    ASSERT_EQ("hit", affectedText->getCalculated(kPropertyText).asString());

    affectedText = root->findComponentById("text6");
    ASSERT_FALSE(affectedText);
    ...
    affectedText = root->findComponentById("text9");
    ASSERT_FALSE(affectedText);
...
TEST_F(MountTest, PagerDelayedOnmount)
{
    ...
    auto affectedText = root->findComponentById("page1");
    ASSERT_TRUE(affectedText->getCalculated(kPropertyLaidOut).getBoolean());
    ASSERT_EQ(0.0, affectedText->getCalculated(kPropertyOpacity).asNumber());

    affectedText = root->findComponentById("page2");
    ASSERT_EQ(0.0, affectedText->getCalculated(kPropertyOpacity).asNumber());

    affectedText = root->findComponentById("page3");
    ASSERT_EQ(0.0, affectedText->getCalculated(kPropertyOpacity).asNumber());

    advanceTime(1000);

    affectedText = root->findComponentById("page1");
    ASSERT_TRUE(affectedText->getCalculated(kPropertyLaidOut).getBoolean());
